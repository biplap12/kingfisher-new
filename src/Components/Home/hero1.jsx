...
const Hero1 = () => {
  return (
    ...
    >
      {/* Center Text */}
      <div className="absolute top-1/4 text-5xl font-bold  tracking-wide uppercase leading-20 left-1/2 z-10 transform -translate-x-1/2 -translate-y-1/2 text-center p-6  main-text ">
         <p>WHERE THE  SEA </p>
          <p>MEETS YOUR SOUL</p>
      </div>
